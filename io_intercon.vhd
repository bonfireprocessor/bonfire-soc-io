...
--
-- Generated by wigen at Sun Jan  9 16:23:58 2022
--
-- Configuration:
--     Number of masters:     1
--     Number of slaves:      5
...
--
-- Command line:
--     wigen -e io_intercon -u 1 5 26 16 32 8
---------------------------------------------------------------------
...
entity io_intercon is
	port(
		...
		m4_adr_o: out std_logic_vector(15 downto 2);
...
select_slave<="00001" when adr_mux(18 downto 16)="000" else
	"00010" when adr_mux(18 downto 16)="001" else
	"00100" when adr_mux(18 downto 16)="010" else
	"01000" when adr_mux(18 downto 16)="011" else
	"10000" when adr_mux(18 downto 16)="100" else
	(others=>'-');
